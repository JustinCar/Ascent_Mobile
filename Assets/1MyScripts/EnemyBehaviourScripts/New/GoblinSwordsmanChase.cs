...
public class GoblinSwordsmanChase : StateMachineBehaviour
{
    ...
    Transform attackPos;
    GoblinSwordsmanAttack enemyAttack;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        enemyAttack = animator.gameObject.GetComponent<GoblinSwordsmanAttack>();
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (!stunned) 
        {
            ...
            } else if (Vector2.Distance(attackPos.transform.position, playerPos.position) < attackRange) 
            {
                ...
                bool playerLeft = health.playerToLeft();

				// Spin attack can hit player when they move behind
				if ((facingLeft && !playerLeft) || (!facingLeft && playerLeft) && enemyAttack.spinAttackTimer <= 0) 
				{
